export default function About() {
  return (
    <div className="mt-[26vh] w-full h-fit bg-black/90 backdrop-blur-lg">
      <div className="flex flex-col items-left justify-center max-w-[1300px] mx-auto px-[15px] md:px-[20px] lg:px-[50px]">
        <div className="grid grid-cols-7 items-center">
          ...
          <h1 className="col-span-7 text-6xl xl:text-7xl font-bold text-white mt-32">Welcome, I'm Dawson.</h1>
          <p className="col-span-7 md:col-span-4 text-3xl md:text-xl text-white/55 mt-5">Web developer dedicated to helping small businesses build a stronger online presence and stand out in today's digital landscape.</p>
          <button className="col-span-7 md:col-span-3 md:justify-self-end flex group w-fit h-fit bg-white/80 text-black px-4 py-2 mt-5 rounded-full text-md sm:text-lg lg:text-2xl font-bold hover:bg-white transform hover:scale-[1.15] transition duration-200 ease-in-out">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-7 gap-3 pb-20 mt-10">
          <div className="bg-gradient-to-b from-neutral-900 to-black/90 rounded-md border-white/15 border-1 text-white group col-span-7 xl:col-span-5">
            <div className="group-hover:bg-gradient-to-tl from-sky-950/40 from-65% to-yellow-700/20 transition duration-500 p-6">
              <img src="/dawson.png" alt="" className="float-left w-[28%] sm:w-[25%] md:w-[19%] xl:w-[25%] px-[3%] pt-[1%] mr-5 rounded-md bg-neutral-800 group-hover:bg-gradient-to-br from-sky-950 to-yellow-700/30 group-hover:scale-110 transition duration-500" />
              <p className="text-base md:text-2xl lg:text-[25px] leading-10 tracking-wide text-white/55 group-hover:text-white transition duration-500">I'm a software developer passionate about building modern, user-focused websites and web applications. With a B.S. in Computer Science from Texas A&M University–Corpus Christi and a strong foundation in both business and technology, I craft digital solutions that not only look great but drive results. I thrive on taking on new challenges and helping businesses level up their online presence.</p>
            </div>
          </div>

          <div className="bg-gradient-to-b from-neutral-900 to-black/90 rounded-md border-white/15 border-1 text-white col-span-3 xl:col-span-2 group">
            <div className="group-hover:bg-gradient-to-br from-sky-950/40 from-25% to-yellow-700/20 transition duration-500 p-5">  
              <h2 className="text-3xl font-bold">About Me</h2>
              <p className="text-base md:text-2xl lg:text-[25px] leading-10 tracking-wide text-white/55 group-hover:text-white transition duration-500">I am a passionate developer with a love for creating modern web applications. I specialize in React and Tailwind CSS.</p>
            </div>
          </div>

          <div className="bg-gradient-to-b from-neutral-900 to-black/90 rounded-md border-white/15 border-1 text-white col-span-4 xl:col-span-2 group">

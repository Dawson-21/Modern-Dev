    ...
    <div className="mt-[26vh] w-full h-fit bg-black/70 backdrop-blur-lg">
      <div className="flex flex-col items-left justify-center max-w-[1100px] mx-auto px-[15px] sm:px-[30px] md:px-[40px] lg:px-[50px]">
        <div className="grid grid-cols-7 items-center">
          ...
          <p className="col-span-7 md:col-span-4 text-[min(4.5vw,20px)] text-white/55 sm:mt-5">Web developer dedicated to helping small businesses build a stronger online presence and stand out in today's digital landscape.</p>
          <button className="col-span-7 md:col-span-3 md:justify-self-end flex group w-fit h-fit bg-white/80 text-black px-4 py-2 mt-5 rounded-full text-[min(4vw,18px)] font-bold hover:bg-white cursor-pointer transform hover:scale-[1.15] transition duration-200 ease-in-out">
            Start a Project <img src="/arrow-black.svg" className="w-6 sm:w-8 pl-1 transform group-hover:translate-x-3 transition duration-200 ease-in-out"/>
          </button>
        </div>

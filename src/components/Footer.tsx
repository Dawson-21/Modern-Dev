  ...
  return (
    <div className="w-full h-24 text-white/55 flex flex-col gap-4 items-center justify-center py-20">
      <div className="flex gap-4">
        <button onClick={() => handleClick('homeSection')} className="text-sm hover:text-white">Home</button>
        <button onClick={() => handleClick('aboutSection')} className="text-sm hover:text-white">About</button>
        <button onClick={() => handleClick('projectsSection')} className="text-sm hover:text-white">Projects</button>
        <button onClick={() => handleClick('servicesSection')} className="text-sm hover:text-white">Services</button>
        <button onClick={() => handleClick('contactSection')} className="text-sm hover:text-white">Contact</button>
      </div>
      <div className="flex gap-4">
        <a href="https://github.com/Dawson-21" target="_blank">
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 24 24"
            className="w-8 h-8 text-neutral-500 hover:text-white transition-colors duration-200"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <a href="#" target="_blank">
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 24 24"
            className="w-8 h-8 text-neutral-500 hover:text-[#165ECB] rounded-sm transition-colors duration-200"
          >
        ...
        <a href="#" target="_blank">
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 24 24"
            className="w-8 h-8 text-neutral-500 hover:text-[#C1355A] transition-colors duration-200"
          >
        ...
        <a href="https://www.linkedin.com/in/dawson-adams21/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 24 24"
            className="w-8 h-8 text-neutral-500 hover:text-[#004182] transition-colors duration-200"
          >
